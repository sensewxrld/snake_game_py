...
musica_de_fundo = pygame.mixer.music.load('90210  [8 Bit Tribute to Travis Scott feat. Kacy Hill] - 8 Bit Wizard.mp3')
...
while True:
    ...
    if lista_cobra.count(lista_cabeca) > 1:
        ...
        mensagem = 'VOCÊ MORREU! Pressione a tecla R para jogar novamente!'
